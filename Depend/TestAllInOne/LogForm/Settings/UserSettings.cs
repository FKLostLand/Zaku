...
namespace Log2Console.Settings
{
    ...
    public sealed class UserSettings
    {
        ...
        {
            new FieldType(LogMessageField.TimeStamp, "时间"),
            new FieldType(LogMessageField.Level, "等级"),
            new FieldType(LogMessageField.RootLoggerName, "进程名"),
            new FieldType(LogMessageField.ThreadName, "线程"),
            new FieldType(LogMessageField.Message, "日志"),
        };
        ...
        {
            new FieldType(LogMessageField.SequenceNr, "序列号"),
            new FieldType(LogMessageField.TimeStamp, "时间"),
            new FieldType(LogMessageField.Level, "等级"),
            new FieldType(LogMessageField.ThreadName, "线程"),
            new FieldType(LogMessageField.CallSiteClass, "类"),
            new FieldType(LogMessageField.CallSiteMethod, "函数"),
            new FieldType(LogMessageField.Message, "日志"),
            new FieldType(LogMessageField.Exception, "异常"),
            new FieldType(LogMessageField.SourceFileName, "源文件名")
        };
        ...
        private static string GetSettingsFilePath()
        {
            ...
            di = di.CreateSubdirectory("LogConfig");
