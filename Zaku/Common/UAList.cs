...
// =============================================================================== 
// Author              :    Frankie.W
// Create Time         :    2019/8/6 10:47:41
// Update Time         :    2019/8/6 10:47:41
...
namespace Zaku
{
    public class UAList
    {
        public List<string> androidUAList { get; private set; }
        public List<string> baiduSpiderUAList { get; private set; }
        public List<string> googleSpiderUAList { get; private set; }
        public List<string> chromeUAList { get; private set; }
        public List<string> firefoxUAList{ get; private set; }
        public List<string> operaUAList { get; private set; }
        public List<string> safariUAList { get; private set; }


        public List<string> uaTypeList { get; private set; }

        public UAList()
        {
            List<string> list = null;

            list = androidUA().Split(new[] { Environment.NewLine }, StringSplitOptions.None).ToList();
            androidUAList = new List<string>(list);

            list = baiduSpiderUA().Split(new[] { Environment.NewLine }, StringSplitOptions.None).ToList();
            baiduSpiderUAList = new List<string>(list);

            list = googleSpiderUA().Split(new[] { Environment.NewLine }, StringSplitOptions.None).ToList();
            googleSpiderUAList = new List<string>(list);

            list = chromeUA().Split(new[] { Environment.NewLine }, StringSplitOptions.None).ToList();
            chromeUAList = new List<string>(list);

            list = firefoxUA().Split(new[] { Environment.NewLine }, StringSplitOptions.None).ToList();
            firefoxUAList = new List<string>(list);

            list = operaUA().Split(new[] { Environment.NewLine }, StringSplitOptions.None).ToList();
            operaUAList = new List<string>(list);

            list = safariUA().Split(new[] { Environment.NewLine }, StringSplitOptions.None).ToList();
            safariUAList = new List<string>(list);

            uaTypeList = new List<string>();
            uaTypeList.Add("普通随机UA");
            uaTypeList.Add("官方爬虫UA");
            uaTypeList.Add("手机平台UA");
            uaTypeList.Add("完全随机UA");
        }

        public int Count()
        {
            return androidUAList.Count + baiduSpiderUAList.Count + googleSpiderUAList.Count +
                chromeUAList.Count + firefoxUAList.Count + operaUAList.Count + safariUAList.Count;
        }
        public string GetUA(string strType)
        {
            ...
            {
                case "普通随机UA":
                    list.Add(chromeUAList[random.Next(chromeUAList.Count)]);
                    list.Add(firefoxUAList[random.Next(firefoxUAList.Count)]);
                    list.Add(operaUAList[random.Next(operaUAList.Count)]);
                    list.Add(safariUAList[random.Next(safariUAList.Count)]);
                    break;
                case "官方爬虫UA":
                    list.Add(baiduSpiderUAList[random.Next(baiduSpiderUAList.Count)]);
                    list.Add(googleSpiderUAList[random.Next(googleSpiderUAList.Count)]);
                    break;
                case "手机平台UA":
                    list.Add(androidUAList[random.Next(androidUAList.Count)]);
                    break;
                case "完全随机UA":
                    list.Add(chromeUAList[random.Next(chromeUAList.Count)]);
                    list.Add(firefoxUAList[random.Next(firefoxUAList.Count)]);
            ...
            return "Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/50.0.2661.87 Safari/537.36";
        }

        public string androidUA()
        {
            return @"
...
BaiDuSpider";
        ...
        public string googleSpiderUA()
        {
            return @"Mozilla/5.0 (compatible; Googlebot/2.1; +http://www.google.com/bot.html)
Googlebot/2.1 (+http://www.googlebot.com/bot.html)
Googlebot/2.1 (+http://www.google.com/bot.html)";
        }
        public string chromeUA()
        {
...
Mozilla / 5.0(Macintosh; U; Intel Mac OS X 10_5_6; en - US) AppleWebKit / 530.5(KHTML, like Gecko) Chrome / Safari / 530.5";
        ...
        public string firefoxUA()
        {
            return @"Mozilla/5.0 (X11; Linux i686; rv:64.0) Gecko/20100101 Firefox/64.0
